...
#define SIMCONNECT_OK ((long)0L)
#define SIMCONNECT_FAIL ((long)1L)
...
namespace simconnect::raw
{
    ...
    #define SIMCONNECTAPI extern "C" HRESULT CALLBACK
    #endif

    using DispatchProc = void(CALLBACK *)(SIMCONNECT_RECV* pData, DWORD cbData, void* pContext);
